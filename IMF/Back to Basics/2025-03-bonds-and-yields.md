...
### Trái phiếu và lợi suất hình thành thế nào

```text
              CHÍNH PHỦ CHI > THU 100 USD → PHÁT HÀNH TRÁI PHIẾU
        cam kết trả gốc 100 + lãi coupon hàng năm (nợ công toàn cầu
                     ~100 nghìn tỷ USD ≈ GDP thế giới)
                                │
                                ▼
                     COUPON BÙ CHI PHÍ CƠ HỘI
             = lạm phát kỳ vọng + lợi suất thực thay thế
                                │
              ┌─────────────────┴─────────────────┐
              │                                   │
              ▼                                   ▼
   coupon 5% = chi phí cơ hội          chi phí cơ hội > 5%
   → mua BẰNG mệnh giá (100)           → chỉ mua DƯỚI mệnh giá (98)
   lợi suất = 5%                        lợi suất = 105/98 − 1 = 7,1%
                                │
                                ▼
            LỢI SUẤT (yield to maturity) = chi phí cơ hội
                     GIÁ ↑ ⇔ LỢI SUẤT ↓
                                │
              ┌─────────────────┴─────────────────┐
              ▼                                   ▼
        SƠ CẤP                              THỨ CẤP
  chính phủ bán cho NĐT            NĐT mua bán lẫn nhau (như cổ phiếu)
  lợi suất phát hành 7,1%          ngân hàng lớn sụp → sợ suy thoái
                                   → chi phí cơ hội 3% → giá 101,95
                                   (TRÊN mệnh giá) = lợi suất thị trường
```

### Đường cong lợi suất nói gì

```text
      KỲ HẠN 1–30 NĂM, mỗi kỳ hạn một lợi suất → ĐƯỜNG CONG
      dài hạn thường cao hơn = PHẦN BÙ KỲ HẠN (bất định lạm phát,
                       kinh tế, bỏ lỡ đầu tư lâu hơn)
                                │
              ┌─────────────────┴─────────────────┐
              │                                   │
              ▼                                   ▼
        DỐC LÊN                             ĐẢO NGƯỢC
  kỳ vọng tăng trưởng nhanh        Fed tăng lãi suất sau COVID
...
### Nước đang phát triển: phần bù rủi ro quốc gia

```text
     NƯỚC TIÊN TIẾN: đa dạng, thể chế mạnh → gần chắc trả nợ
                                │
                                ▼
     NƯỚC ĐANG PT: thể chế yếu, dễ sốc → mất giá tiền tệ,
     lạm phát, mất tiếp cận thị trường → có thể tái cơ cấu nợ
     (đổi lịch trả, lợi suất) nhất là nợ ngoại tệ lớn
                                │
                                ▼
   ...
   cần quản lý nợ tốt, luật, hạ tầng thị trường, NĐT trong nước đa dạng
   (IMF + WB hỗ trợ; châu Á, Mỹ Latinh tiến bộ) → đường cong lợi suất
   = chuẩn định giá vay dài hạn, TP doanh nghiệp, thế chấp → tăng trưởng
```

## Ba câu hỏi bài viết đặt ra
...
|---|---|
| Principal | Gốc: số tiền chính phủ cam kết trả lại khi đáo hạn |
| Coupon | Lãi hàng năm trả cho người nắm trái phiếu |
| Opportunity cost | Chi phí cơ hội = lạm phát kỳ vọng + lợi suất thực từ đầu tư thay thế |
| Par / below par / above par | Bằng / dưới / trên mệnh giá |
| Yield to maturity | Lợi suất đến đáo hạn: tổng lợi nhuận thực nhận, bằng chi phí cơ hội của nhà đầu tư |
| Primary / secondary market | Thị trường sơ cấp (chính phủ bán) / thứ cấp (nhà đầu tư mua bán lẫn nhau) |
| Issuance yield vs market yield | Lợi suất lúc phát hành so với lợi suất thị trường hiện hành |
| Term premium | Phần bù kỳ hạn: lợi suất thêm cho trái phiếu dài hạn |
| Yield curve | Đường cong lợi suất: lợi suất theo kỳ hạn tại một thời điểm |
| Inverted yield curve | Đường cong đảo ngược: ngắn hạn cao hơn dài hạn, thường báo suy thoái |
| Country risk premium / default risk | Phần bù rủi ro quốc gia / rủi ro vỡ nợ |
| Spread | Chênh lệch lợi suất so với trái phiếu an toàn, chỉ báo rủi ro tín dụng |
| Debt restructuring | Tái cơ cấu nợ: đổi lịch trả, lợi suất, hoặc cả hai |
| Local-currency bond market | Thị trường trái phiếu nội tệ, giảm rủi ro tỷ giá |
