# Why Development Feels Harder — Vì sao phát triển ngày càng khó

**Nguồn:** Tạp chí Finance & Development của IMF, số tháng 9/2026.

**Tác giả:** Muhamad Chatib Basri, nguyên Bộ trưởng Tài chính Indonesia, học giả thỉnh giảng tại Trung tâm Phát triển Quốc tế Đại học Harvard.

**Ý chính:** Bài mở đầu bằng cái chết của Affan Kurniawan, 21 tuổi, tài xế giao đồ ăn, bị xe bọc thép của cảnh sát cán chết tại Jakarta ngày 28/8/2025 trong cuộc biểu tình trước tòa nhà Quốc hội. Bối cảnh: các nghị sĩ vừa tự bỏ phiếu cho mình một khoản phụ cấp nhà ở hậu hĩnh, và những đoạn video họ nhảy múa khi dự luật được thông qua đã lan truyền khắp mạng xã hội. Đoạn video về cái chết của Kurniawan biến sự phẫn nộ thành một phong trào.

Điều quan trọng, và là luận điểm trung tâm: **Kurniawan không nghèo**. Tài xế của các siêu ứng dụng ở Jakarta kiếm khoảng **272 USD mỗi tháng — gấp chín lần ngưỡng nghèo 30 USD**. Đây là một tầng lớp "bấp bênh" lo lắng về công việc và công lý, không phải về bữa ăn kế tiếp.

**Luận điểm cốt lõi:** *"Tăng trưởng làm thay đổi cơ cấu việc làm. Khi tăng trưởng thôi tạo ra việc làm ổn định và cơ hội thăng tiến, sự bất an lan ra khỏi nhóm người nghèo và thấm vào tầng lớp trung lưu đang vươn lên. Kỳ vọng vượt lên trên cơ hội, và chính trị trở thành nút thắt ràng buộc."*

Indonesia có hai thập niên tăng trưởng 5%, lạm phát thấp, thâm hụt ngân sách dưới 3% GDP. Nhưng **"sự thịnh vượng trên bảng điều khiển cùng tồn tại với sự giận dữ trên đường phố."** Tầng lớp trung lưu Indonesia đã **co lại từ 21% dân số năm 2019 xuống 16,6% vào năm 2025**, trong khi nhóm "đang vươn lên tầng lớp trung lưu" nở ra tới gần một nửa dân số — khoảng **137 triệu người**. Và **80% việc làm mới trong giai đoạn 2019–24 là việc làm phi chính thức, trả khoảng 114 USD/tháng, thấp hơn mức lương tối thiểu 181 USD**.

Chẩn đoán cấu trúc: **băng chuyền đã hỏng**. Ba mươi năm trước, tăng trưởng 5% gần như tự động chuyển thành việc làm chế tạo chính thức. Nay tăng trưởng chảy qua các ngành thâm dụng vốn (luyện nickel, chế biến khoáng sản) tạo ra sản lượng và xuất khẩu nhưng rất ít việc làm, và chảy qua dịch vụ — vốn vướng hai giới hạn: **bệnh chi phí Baumol** và **phần lớn dịch vụ không thể giao dịch xuyên biên giới**.

Công thức chính sách gói gọn trong bốn chữ: **"Đền bù trước, cải cách sau."**

> **Lưu ý:**
> - Đây là **bài bình luận chính sách của một cựu bộ trưởng**, không phải bài nghiên cứu. Vì vậy mức độ trích dẫn nguồn thưa hơn hẳn các tài liệu khác trong thư mục, và điều đó là bình thường với thể loại này — nhưng người đọc cần ý thức rằng nhiều con số không kèm nguồn kiểm chứng được.
> - **Các con số then chốt không có nguồn.** Mức co lại của tầng lớp trung lưu từ 21% xuống 16,6% không được dẫn nguồn. Nhận định rằng tầng lớp trung lưu cũng đang co lại ở Ấn Độ, Thái Lan, Việt Nam và Brazil chỉ được ghi là "theo nghiên cứu của IMF" mà không nêu nghiên cứu nào.
> - **Năm cắt trợ giá xăng dầu được ghi hai cách khác nhau** trong cùng bài: một chỗ viết "các đợt cắt giảm quan trọng năm **2013–14**", chỗ khác viết "các đợt cắt trợ giá nhiên liệu năm **2013** của Indonesia".
> - Bệnh chi phí Baumol được mô tả là "đặt theo tên nhà kinh tế học Mỹ đã mô tả nó lần đầu trong thập niên 1960" nhưng **tên đầy đủ của ông không bao giờ được nêu** ngoài chữ "Baumol" trong tên gọi hiện tượng.
> - **Một căng thẳng nội tại đáng suy nghĩ hơn là một lỗi:** bài chọn một người kiếm 272 USD/tháng — gấp chín lần ngưỡng nghèo và gấp rưỡi lương tối thiểu — làm biểu tượng cho tầng lớp bấp bênh, trong khi toàn bộ lập luận sau đó dựa trên việc lao động phi chính thức chỉ kiếm 114 USD. Bài có nêu lý do (bất an là về sự ổn định và công lý, không phải về mức thu nhập) nhưng không bao giờ nối hai con số này lại một cách rõ ràng.

## Sơ đồ

Nghịch lý trung tâm — số liệu đẹp, đường phố giận dữ:

```text
  BẢNG ĐIỀU KHIỂN VĨ MÔ           ĐƯỜNG PHỐ
  ─────────────────────           ─────────────────────────
  ✔ Tăng trưởng 5%/năm            ✘ Trung lưu co từ 21% → 16,6%
    suốt hai thập niên            ✘ 80% việc làm mới là PHI
  ✔ Lạm phát thấp                   CHÍNH THỨC, 114 USD/tháng
  ✔ Thâm hụt NS < 3% GDP            (lương tối thiểu: 181 USD)
  ✔ Ổn định vĩ mô                 ✘ Nhóm "đang vươn lên" nở ra
                                    gần một nửa dân số: ~137 triệu
                                  ✘ Nhóm phân vị 50–80: tiêu dùng
                                    thực GIẢM từ 2019 đến 2022
  ═══════════════════════════════════════════════════════════
  ★★ "Sự thịnh vượng trên bảng điều khiển cùng tồn tại với
      sự giận dữ trên đường phố."
  ⟹ Các chỉ số vĩ mô chuẩn KHÔNG ĐO ĐƯỢC cái đang xảy ra,
    vì chúng đo MỨC ĐỘ chứ không đo CƠ CẤU và SỰ ỔN ĐỊNH
    của việc làm.
```

Vì sao người không nghèo lại xuống đường:

```text
  AFFAN KURNIAWAN, 21 tuổi, tài xế giao đồ ăn
  Bị xe bọc thép cảnh sát cán chết, Jakarta, 28/8/2025
                        │
  Thu nhập tài xế siêu ứng dụng: ~272 USD/tháng
                        │
     ┌──────────────────┼──────────────────┐
     ▼                  ▼                  ▼
  Ngưỡng nghèo      Lương tối thiểu   Lương phi chính
  30 USD            181 USD           thức 114 USD
  → gấp 9 LẦN       → gấp 1,5 LẦN     → gấp 2,4 LẦN
     └──────────────────┬──────────────────┘
                        ▼
              ★ NGƯỜI NÀY KHÔNG NGHÈO
                        │
                        ▼
  VẬY VÌ SAO GIẬN DỮ? ⟹ "một tầng lớp BẤP BÊNH lo lắng
  về công việc và công lý, KHÔNG PHẢI về bữa ăn kế tiếp"
                        │
  Bối cảnh châm ngòi: nghị sĩ tự bỏ phiếu cho mình phụ cấp
  nhà ở hậu hĩnh; video họ NHẢY MÚA khi dự luật thông qua
  lan truyền khắp mạng
                        │
                        ▼
  ⚠ BẤT AN không phải là hàm của MỨC THU NHẬP
    mà là hàm của ĐỘ ỔN ĐỊNH và CẢM NHẬN VỀ CÔNG BẰNG
```

Băng chuyền đã hỏng — cơ chế cốt lõi:

```text
  BA MƯƠI NĂM TRƯỚC
  Tăng trưởng 5%  ──► gần như TỰ ĐỘNG ──► việc làm CHẾ TẠO
                                            CHÍNH THỨC
                                              │
                                              ▼
                                    lương ổn định, bảo hiểm,
                                    thăng tiến được, con cái
                                    học lên được

  ═══════════════════════════════════════════════════════════
  "Băng chuyền đó đã ngừng chạy."
  ═══════════════════════════════════════════════════════════

  NGÀY NAY
  Tăng trưởng 5% ──┬──► ① NGÀNH THÂM DỤNG VỐN
                   │     (luyện nickel, chế biến khoáng sản)
                   │     → sản lượng ↑, xuất khẩu ↑
                   │     → VIỆC LÀM rất ít             ✘
                   │
                   └──► ② DỊCH VỤ
                         → hút được nhiều người
                         → nhưng vướng HAI GIỚI HẠN (dưới)

  ⟹ RODRIK: PHI CÔNG NGHIỆP HÓA SỚM
     (premature deindustrialization)
     Tỷ trọng công nghiệp đạt đỉnh ở mức thu nhập THẤP HƠN
     NHIỀU so với các nước đi trước, rồi giảm
  Ví dụ cực đoan: PHILIPPINES nhảy thẳng từ nông nghiệp
  sang dịch vụ mà KHÔNG xây nhà máy — đỉnh công nghiệp ở
  mức thu nhập thấp hơn hẳn các nước láng giềng
  Ví dụ khác: THÁI LAN đạt thu nhập trung bình rồi bất ổn
  chính trị làm đình trệ chuyển dịch cơ cấu
```

Hai giới hạn của mô hình dịch vụ:

```text
  ① PHÂN CỰC + BỆNH CHI PHÍ BAUMOL
  ┌──────────────────────┬──────────────────────────────────┐
  │ Dịch vụ KỸ NĂNG CAO  │ Dịch vụ HẤP THỤ LAO ĐỘNG         │
  │ có thể giao dịch     │ (chăm sóc, giáo dục, nhà hàng    │
  │ (thiết kế, phần mềm, │  khách sạn)                      │
  │  R&D, logistics)     │                                  │
  ├──────────────────────┼──────────────────────────────────┤
  │ Năng suất CAO        │ Năng suất gần như KHÔNG TĂNG     │
  │ Hút ÍT lao động      │ Hút NHIỀU lao động               │
  │                      │                                  │
  │                      │ ⚠ NHƯNG vẫn phải trả lương tăng  │
  │                      │   theo mặt bằng chung nền kinh tế│
  │                      │   (nếu không thì không ai làm)   │
  │                      │            ↓                     │
  │                      │   CHI PHÍ TƯƠNG ĐỐI LEO THANG    │
  │                      │   trong khi sản lượng/người      │
  │                      │   ĐỨNG YÊN                       │
  │                      │            ↓                     │
  │                      │   ★ GIÁ TĂNG cho đúng những dịch │
  │                      │     vụ mà tầng lớp trung lưu     │
  │                      │     PHỤ THUỘC VÀO NHẤT           │
  └──────────────────────┴──────────────────────────────────┘

  ② PHẦN LỚN DỊCH VỤ KHÔNG THỂ GIAO DỊCH XUYÊN BIÊN GIỚI
  ┌─────────────────────────────────────────────────────────┐
  │ CHẾ TẠO: có thể BÁN RA THẾ GIỚI                         │
  │   → tăng trưởng KHÔNG bị chặn bởi sức mua trong nước    │
  │                                                          │
  │ DỊCH VỤ: phần lớn chỉ bán được TẠI CHỖ                  │
  │   → tăng trưởng BỊ CHẶN bởi sức mua trong nước          │
  │   → mà sức mua trong nước lại phụ thuộc vào... thu nhập │
  │     từ chính các việc làm đó → VÒNG LẶP KHÉP KÍN        │
  └─────────────────────────────────────────────────────────┘
  ★★ "Chế tạo có thể vượt ra ngoài thị trường nội địa bằng
      cách bán cho thế giới; dịch vụ thì không. Đó là lý do
      phi công nghiệp hóa ở mức thu nhập thấp có sức ăn mòn:
      nó lấy đi NGÀNH DUY NHẤT có thể NÂNG SÀN LƯƠNG cho
      tất cả những người còn lại."

  ⚠ RANH GIỚI THẬT: "Ranh giới thật không còn nằm giữa làm
    ra đồ vật và cung cấp dịch vụ, mà nằm giữa cái CÓ THỂ
    giao dịch xuyên biên giới và cái KHÔNG THỂ."
    → Khái niệm "DỊCH VỤ HÓA" (servicification): thiết kế,
      phần mềm, logistics, R&D nay đóng góp giá trị nhiều
      hơn cả linh kiện và công lắp ráp trong một sản phẩm
      chế tạo
```

Vì sao cải cách ngày càng khó — ví dụ trợ giá nhiên liệu:

```text
  MƯỜI NĂM TRƯỚC (đợt cắt 2013)
  Trợ giá nhiên liệu chủ yếu có lợi cho hộ thu nhập CAO
  (họ mới có ô tô, xe máy)
            ▼
  ⟹ Cắt trợ giá = LẤY CỦA NGƯỜI GIÀU
  ⟹ Đền bù người nghèo bằng tiền mặt là ĐỦ
  ⟹ Cải cách khả thi về mặt chính trị        ✔

  ═══════════════════════════════════════════════════════════
  THU NHẬP TĂNG LÊN → SỞ HỮU PHƯƠNG TIỆN LAN XUỐNG DƯỚI
  ═══════════════════════════════════════════════════════════

  NGÀY NAY
  Cắt trợ giá cũng ĐÁNH THẲNG vào nhóm "đang vươn lên
  tầng lớp trung lưu" — ~137 triệu người, nhóm ĐANG LO LẮNG
  NHẤT và có tiếng nói chính trị MẠNH NHẤT
            ▼
  ⚠ Nhóm này KHÔNG đủ nghèo để nhận trợ cấp,
    KHÔNG đủ giàu để chịu được cú sốc
  ⟹ Cải cách trở nên KHÔNG KHẢ THI về chính trị   ✘

  ★ NGHỊCH LÝ: CHÍNH THÀNH CÔNG CỦA PHÁT TRIỂN
    LÀM CHO CẢI CÁCH KHÓ HƠN
```

Giải pháp — đền bù trước, cải cách sau:

```text
  ┌─────────────────────────────────────────────────────────┐
  │           "ĐỀN BÙ TRƯỚC, RỒI MỚI CẢI CÁCH"              │
  │         (Compensate first, then reform)                 │
  └─────────────────────────────────────────────────────────┘
                            │
       CÁCH LÀM CỤ THỂ — dữ liệu đã có sẵn trong tay
                            │
  ① Công ty điện lực nhà nước nắm dữ liệu TỪNG HỘ:
     tên, địa chỉ, và MỨC TIÊU THỤ ĐIỆN
                            │
  ② Ghép với dữ liệu bảo trợ xã hội
                            │
  ③ ⟹ Nhận diện được NGƯỜI NGHÈO và NHÓM ĐANG VƯƠN LÊN
                            │
  ④ ⟹ Trợ giá ĐÚNG NGƯỜI; những người còn lại TRẢ GIÁ ĐẦY ĐỦ
                            │
                            ▼
  ★ Bài học: nút thắt không phải THIẾU DỮ LIỆU mà là
    THIẾU Ý CHÍ GHÉP DỮ LIỆU LẠI VỚI NHAU

  ⚠ NHƯNG NGAY CẢ THẾ VẪN CHƯA ĐỦ:
  "Các đợt cắt trợ giá nhiên liệu của Indonesia là ĐÚNG ĐẮN:
   người nghèo đã được đền bù, lý lẽ đã được trình bày công
   khai — vậy mà người ta vẫn phản đối. ĐÚNG KHÔNG ĐỒNG NGHĨA
   VỚI ĐƯỢC CHẤP NHẬN."
```

Ba nguyên tắc chính trị kinh tế của cải cách:

```text
  ① THỜI ĐIỂM QUYẾT ĐỊNH
     "cải cách chỉ có tác dụng khi nó phù hợp với chính trị
      của thời điểm đó... Dư địa xoay xở LUÔN LUÔN ÍT HƠN
      những gì kế hoạch đòi hỏi."

  ② LỢI ÍCH NHÓM CÓ MẶT Ở CHỖ KHÔNG NGỜ TỚI
     "Theo thời gian, thủ tục hành chính rườm rà TẠO RA THU
      NHẬP cho chính những người thực thi nó. Cắt giảm nó
      không chỉ là đơn giản hóa quy trình; nó LẤY ĐI MỘT
      PHẦN THU NHẬP của một số công chức, và HỌ SẼ CHỐNG LẠI.
      Lý lẽ hay KHÔNG THUYẾT PHỤC ĐƯỢC HỌ; khu vực tư nhân
      phải gánh phần lớn công việc này."

  ③ CẢI CÁCH PHẢI SỐNG LÂU HƠN NGƯỜI KHỞI XƯỚNG
     "Một chính sách chỉ dựa trên niềm tin của MỘT vị bộ
      trưởng có thể bị người kế nhiệm xóa bỏ. Nhiệm vụ là
      VIẾT CẢI CÁCH VÀO LUẬT VÀ THỂ CHẾ để nó sống lâu hơn
      người đã khởi xướng nó."
```

## Ba câu hỏi bài viết trả lời

1. **Vì sao các nước có số liệu vĩ mô tốt vẫn bùng nổ bất ổn xã hội?** Vì các chỉ số vĩ mô chuẩn đo **mức độ** chứ không đo **cơ cấu và độ ổn định** của việc làm. Indonesia có 5% tăng trưởng, lạm phát thấp và thâm hụt dưới 3% GDP, nhưng 80% việc làm mới giai đoạn 2019–24 là phi chính thức và trả dưới mức lương tối thiểu, còn nhóm ở phân vị 50 đến 80 có tiêu dùng thực **giảm** từ 2019 đến 2022. Tăng trưởng vẫn diễn ra nhưng đã thôi tạo ra loại việc làm cho phép người ta tiến lên.

2. **Vì sao mô hình phát triển kiểu cũ không còn hiệu quả?** Vì băng chuyền đã hỏng. Ba mươi năm trước, tăng trưởng gần như tự động chuyển thành việc làm chế tạo chính thức. Nay tăng trưởng chảy qua các ngành thâm dụng vốn tạo ít việc làm, và qua dịch vụ — vốn vướng hai giới hạn nghiêm trọng: bệnh chi phí Baumol khiến các dịch vụ hấp thụ lao động ngày càng đắt mà năng suất không tăng, và việc phần lớn dịch vụ không giao dịch được xuyên biên giới khiến tăng trưởng bị chặn bởi sức mua trong nước.
...
| English | Tiếng Việt |
|---|---|
| Precariat | Tầng lớp bấp bênh |
| Aspiring middle class | Nhóm đang vươn lên tầng lớp trung lưu |
| Informal employment | Việc làm phi chính thức |
| Shadow economy | Kinh tế ngầm |
| Open unemployment | Thất nghiệp công khai |
| Minimum wage | Lương tối thiểu |
| Poverty line | Ngưỡng nghèo |
| Gig economy / super-app drivers | Kinh tế việc làm tự do / tài xế siêu ứng dụng |
| Upward mobility | Khả năng thăng tiến xã hội |
| Binding constraint | Nút thắt ràng buộc |
| Premature deindustrialization | Phi công nghiệp hóa sớm |
| Capital-intensive | Thâm dụng vốn |
| Labor-absorbing | Hấp thụ lao động |
| Baumol's cost disease | Bệnh chi phí Baumol |
| Polarization | Phân cực (thị trường lao động) |
| Tradable / nontradable | Có thể / không thể giao dịch xuyên biên giới |
| Servicification | Dịch vụ hóa |
| Wage floor | Sàn lương |
| Dutch disease | Bệnh Hà Lan |
| Export diversification | Đa dạng hóa xuất khẩu |
| Fuel subsidy | Trợ giá nhiên liệu |
| Targeted subsidy | Trợ giá có mục tiêu |
| Social protection data | Dữ liệu bảo trợ xã hội |
| Compensate first, then reform | Đền bù trước, cải cách sau |
| Lean industrial policy | Chính sách công nghiệp tinh gọn |
| Capability focused | Tập trung vào năng lực |
| Red tape | Thủ tục hành chính rườm rà |
| Vested interest | Lợi ích nhóm cố hữu |
| Back-office work | Công việc hậu kỳ văn phòng |
| Public goods that work | Hàng hóa công hoạt động được |

## Câu nói đáng nhớ

> "Growth changes the composition of jobs. When growth stops creating secure employment and upward mobility, insecurity spreads beyond the poor into the aspiring middle. Expectations outrun opportunities, and politics becomes the binding constraint."

> "Prosperity on the dashboard coexists with anger on the street."

> "Thirty years ago, 5 percent growth translated almost mechanically into formal manufacturing jobs. That conveyor belt has stalled."

> "Open unemployment is a luxury reserved for those with savings or family. The rest end up in the shadow economy."

> "Manufacturing can outgrow the home market by selling to the world; services cannot, which is why deindustrialization at low income is corrosive: It removes the one sector that can lift the wage floor for everyone else."

> "The real divide is no longer between making things and providing services but between what can be traded across borders and what cannot."

> "Over time, red tape generates income for those who administer it. Cutting it is not just about simplifying procedures; it takes away some bureaucrats' income, and they will resist. Good arguments won't win them over; the private sector must do more of the work."

> "A policy that rests on one minister's conviction can be undone by the next. The task is to write reform into law and institutions so that it outlives the person who originated it."
